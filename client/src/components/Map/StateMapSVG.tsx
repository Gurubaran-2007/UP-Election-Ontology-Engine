      ...
      try {
        ...
        const zoom = d3.zoom<SVGSVGElement, unknown>()
          ...
          .on('zoom', (event) => {
            ...
            labelGroup.selectAll('.region-label')
              ...
              .style('opacity', event.transform.k > 3 ? 0 : 0.5);
          });
        svg.call(zoom);
        ...
        pathGroup.selectAll<SVGPathElement, any>('path')
          ...
          .style('fill', (d: any) => {
            ...
            return getDistrictRegion(name).color + '55'; // semi-transparent
          })
          .style('stroke', '#334155')
          ...
          .on('mouseout', function (_, d: any) {
            ...
            if (!isSelected) {
              d3.select(this).transition().duration(150)
                .style('fill', getDistrictRegion(name).color + '55')
                .style('stroke', '#334155')
                .style('stroke-width', '0.5px');
            }
          })
          .on('click', function (_, d: any) {
            ...
            if (lastSelectedRef.current) {
              ...
              const prevName = prevData?.properties?.NAME_2 || prevData?.properties?.name || '';
              lastSelectedRef.current
                .style('stroke', '#334155')
                .style('stroke-width', '0.5px')
                .style('fill', getDistrictRegion(prevName).color + '55');
            }
        ...
        console.error('[STATE MAP] Failed:', err.message);
      }
    };
